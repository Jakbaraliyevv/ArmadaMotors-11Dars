...
function Swipper() {
  ...
  return (
    <div className="max-[1072px]:text-[0.8em  ]">
      <div className="mainContainer flex  gap-[1em] aksiya">
          ...
          {data?.map((value) => (
            <div key={value.id}>
              ...
              <div className=" flex flex-col items-center justify-center gap-2 p-2">
                <h2 className="text-[1.2em] font-bold text-[#0157be]">
                  {value.price}
                </h2>
                <p className="text-sm text-[#000] text-center text-[1em]">
